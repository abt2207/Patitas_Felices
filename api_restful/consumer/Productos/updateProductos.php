...
if ($_SERVER["REQUEST_METHOD"]=="POST")
    ...
    $ins = json_encode(array("id_mascota"=>"$id_mascota", "nombre_mascota"=>"$nombre_mascota", "tipo"=>"$tipo" ,  "genero"=>"$genero" , "edad"=>"$edad",  "color"=>"$color" , "adoptado"=>"$adoptado"));
     
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => 'http://127.0.0.1/integradoraOFICIAL/api_restful/controllers/productos.php?op=update',
